                                    ...
                                    <div class="total-cart">
                                        ...
                                        <div class="cart-item">
                                            <div class="single-item">
                                                <div class="item-img">
                                                    <a href="#">
                                                        <img src="{{asset('themes/frontend/img/cart/item1.jpg')}}" alt="" class="img-responsive">
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                            ...
                                            <div class="single-item">
                                                <div class="item-img">
                                                    <a href="#">
                                                        <img src="{{asset('themes/frontend/img/cart/item2.jpg')}}" alt="" class="img-responsive">
                                                    </a>
                                                </div>
                                                <div class="item-info">
                    ...
                    <div class="col-lg-9 col-lg-offset-3 col-md-12">
                        <div class="section-heading mt-40">
                            <div class="row">
                                <!-- section title start -->
                                <div class="col-md-4 col-sm-5">
                                    <h2 class="sweet small-icon-size"> <img src="{{asset('themes/frontend/img/icon/icon_fashion.jpg')}}" alt="">
                                        fashion</h2>
                                </div>
                                <!-- section title end -->
                                <div class="col-md-8 col-sm-7 col-xs-12">
                    ...
                    <div class="col-md-12">
                        <div class="section-heading mt-40">
                            <div class="row">
                                <!-- section title start -->
                                <div class="col-md-4 col-sm-5">
                                    <h2 class="brown small-icon-size"> <img src="{{asset('themes/frontend/img/icon/icon_Furniture.jpg')}}" alt="">
                                        Furnitured & Decor</h2>
                                </div>
                                <!-- section title end -->
                                <div class="col-md-8 col-sm-7 col-xs-12">
                    ...
                    <div class="col-lg-9 col-lg-offset-3 col-md-12">
                        <div class="section-heading mt-40">
                            <div class="row">
                                <!-- section title start -->
                                <div class="col-md-4 col-sm-5">
                                    <h2 class="green small-icon-size"> <img src="{{asset('themes/frontend/img/icon/icon_sunglass.jpg')}}" alt="">
                                        Accessories</h2>
                                </div>
                                <!-- section title end -->
                                <div class="col-md-8 col-sm-7 col-xs-12">
                        ...
                        <div class="section-heading mt-40">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-3">
                                    <h2> <img src="{{asset('themes/frontend/img/icon/icon_categories.png')}}" alt=""> Our Categories</h2>
                                </div>
                            </div>
                        </div>
                    </div>
