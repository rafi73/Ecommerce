                ...
                <form @submit.prevent="register" @keydown="form.onKeydown($event)">
                    ...
                    <v-card-text>
                        ...
                        <text-input :form="form" :label="$t('name')" :v-errors="errors" :value.sync="form.name"
                            browser-autocomplete="name" counter="30" name="name" v-validate="'required|max:30'"></text-input>
                        ...
                        <password-input :form="form" :hint="$t('password_length_hint')" :v-errors="errors" :value.sync="form.password"
                            browser-autocomplete="new-password" v-on:eye="eye = $event" name="password" v-validate="'required|min:8'"></password-input>
                        ...
                        <password-input :form="form" :hide="eye" :label="$t('confirm_password')" :v-errors="errors"
                            ...
                            hide-icon="true" name="password_confirmation" v-validate="'required|confirmed:password'"></password-input>
